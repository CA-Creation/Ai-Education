        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/introduction" className="text-gray-400 hover:text-white">Getting Started</Link></li>
              <li><Link to="/future" className="text-gray-400 hover:text-white">Future of AI</Link></li>
            </ul>
          </div>
          <div>
